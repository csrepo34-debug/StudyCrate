...
const INSIDE_KIT_BLOCKS = [
  {
    image: '/eda-main-page/intermediate/intermediate1.png',
  ...
  {
    image: '/eda-main-page/intermediate/intermediate2.png',
  ...
  {
    image: '/eda-main-page/intermediate/intermediate3.png',
    alt: 'EDA Exercises',
