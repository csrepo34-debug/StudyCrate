  ...
  return (
    <div className="space-y-3">
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold">Nature of Products</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold">No Cancellation After Purchase</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold">No Refund After Download</h2>
        <ul className="list-disc list-inside space-y-1">
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold">Refund Eligibility (Exceptional Cases Only)</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold">Resolution Before Refund</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold">Processing of Approved Refunds</h2>
        <ul className="list-disc list-inside space-y-1">
