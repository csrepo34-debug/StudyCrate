  ...
  return (
    <div className="space-y-4">
      ...
      <section className="space-y-2">
        <h3 className="text-xl font-semibold">1.1 Information Collected</h3>
      ...
      <section className="space-y-2">
        <h3 className="text-xl font-semibold">1.2 Use of Information</h3>
      ...
      <section className="space-y-2">
        <h3 className="text-xl font-semibold">1.3 Data Sharing</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-xl font-semibold">1.4 Data Security</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-xl font-semibold">1.5 User Rights</h3>
