...
export default function PrivacyPage() {
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-semibold">2. Privacy Policy</h1>

      <section className="space-y-2">
        <h2 className="text-xl font-semibold">2.1 Information Collected</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold">2.2 Use of Information</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold">2.3 Data Sharing</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold">2.4 Data Security</h2>
        <p>
